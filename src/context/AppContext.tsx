...
const useApp = () => { // "export" anahtar kelimesi kaldırıldı
...
const AppProvider: React.FC<AppProviderProps> = ({ children }) => { // "export" anahtar kelimesi kaldırıldı
...
const BuildingsPage: React.FC = () => {
  // Buradaki import satırı kaldırıldı, çünkü useApp artık aynı dosyada tanımlı ve export edilmiyor.
